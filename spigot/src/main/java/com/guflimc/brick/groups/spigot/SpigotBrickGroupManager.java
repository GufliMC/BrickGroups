...
import com.guflimc.brick.groups.spigot.api.SpigotClanManager;
...
import com.guflimc.brick.groups.common.BaseGroupManager;
import com.guflimc.brick.groups.common.GroupDatabaseContext;
import org.bukkit.inventory.ItemStack;
import org.jetbrains.annotations.NotNull;

public class SpigotBrickGroupManager extends BaseGroupManager implements SpigotClanManager {

    public SpigotBrickGroupManager(GroupDatabaseContext databaseContext) {
        super(config, databaseContext);
        setupCrests();
    }

    @Override
    public ItemStack crest(@NotNull Group team) {
