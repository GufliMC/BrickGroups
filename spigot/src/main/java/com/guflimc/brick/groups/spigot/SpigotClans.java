...
import com.guflimc.brick.groups.spigot.chat.ClanChat;
import com.guflimc.brick.groups.spigot.commands.SpigotClanCommands;
...
import com.guflimc.brick.groups.common.GroupConfig;
import com.guflimc.brick.groups.common.GroupDatabaseContext;
import com.guflimc.brick.groups.common.EventManager;
import com.guflimc.brick.groups.common.commands.GroupCommands;
import com.guflimc.teams.common.commands.arguments.ClanArgument;
import com.guflimc.brick.groups.spigot.commands.SpigotCrestCommands;
import com.guflimc.brick.groups.spigot.listeners.ClanListener;
import com.guflimc.brick.groups.spigot.listeners.JoinQuitListener;
import com.guflimc.brick.groups.spigot.placeholders.ClanPlaceholders;
...
public class SpigotClans extends JavaPlugin {
    ...
    private GroupDatabaseContext databaseContext;
    public SpigotBrickGroupManager clanManager;
    ...
    public void onEnable() {
        // CONFIG
        config = TomlConfig.load(getDataFolder().toPath().resolve("config.toml"), new GroupConfig());
        ...
        // DATABASE
        databaseContext = new GroupDatabaseContext(config.database);

        // EVENT MANAGER
        EventManager.INSTANCE = new SpigotEventManager();

        // CLAN MANAGER
        clanManager = new SpigotBrickGroupManager(databaseContext);
...
//            commandManager.registerBrigadier();
            ...
            commandManager.parserRegistry().registerParserSupplier(TypeToken.get(Group.class),
            ...
            annotationParser.parse(new GroupCommands(adventure));
